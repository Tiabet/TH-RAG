...
# Create directed multigraph to preserve duplicate relations
G = nx.MultiDiGraph()
...
for entry in entries:
    ...
    G.add_edge(
        subj_node, subj_st_node, label="has_subtopic", relation_type="subtopic_relation"
    )
    G.add_edge(
        subj_st_node, subj_mt_node, label="has_topic", relation_type="topic_relation"
    )
    G.add_edge(
        obj_node, obj_st_node, label="has_subtopic", relation_type="subtopic_relation"
    )
    G.add_edge(
        obj_st_node, obj_mt_node, label="has_topic", relation_type="topic_relation"
    )
